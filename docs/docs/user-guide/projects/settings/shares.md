...
| **Data**          | **Live** or **Frozen** for report shares. See [Live and Frozen Data](../../share-links.md#live-and-frozen-data). |
...
- **Delete** — remove the link from the list. The link stops working.

You can also toggle **view notifications** directly from the Notifications column for active links.

:::info
For the full reference on share modes, live and frozen data, creating links, password protection, expiration, and view counts, see [Share Links](../../share-links.md).
:::
