...
# TestPlanIt Source Code is Now Available to Everyone
...
For detailed setup including database configuration and Docker deployment options, check out our [Installation Guide](/docs/installation).
