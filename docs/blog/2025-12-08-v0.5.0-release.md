...
description: "TestPlanIt v0.5.0 introduces comprehensive audit logging for security and compliance, tracking authentication events, data operations, and access control changes."
authors: [testplanit]
