...
description: "TestPlanIt v0.6.0 adds Two-Factor Authentication (2FA) with TOTP support, backup codes, and admin controls to enforce 2FA across your organization."
authors: [testplanit]
