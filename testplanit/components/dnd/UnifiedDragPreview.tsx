          ...
          >
            ...
            {isOverReorderZone ? (
              <div
                ...
                className="absolute -top-2 -right-2 rounded-full bg-secondary-foreground/70 text-secondary p-1 ring-2 ring-background"
              >
                <ArrowUpDown size={16} />
              </div>
            ) : (
              <>
                {copyHeld && (
                  <div
                    ...
                    className="absolute -top-2 -right-2 rounded-full bg-primary-foreground/70 text-primary p-1 ring-2 ring-background"
                  >
                    <Copy size={16} />
                  </div>
                )}
