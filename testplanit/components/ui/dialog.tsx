  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "overflow-y-auto fixed z-50 grid sm:rounded-lg gap-4 border bg-background p-6 pt-8 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]",
          isFullScreen
            ? "min-w-full h-screen left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]"
            : "max-h-[90vh] w-full max-w-lg left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]",
          className
        )}
        {...props}
      >
        ...
        <div className="absolute right-4 top-4 space-x-2">
          ...
          >
            <SquareArrowUpRight
              className={`h-4 w-4 ${isFullScreen ? "rotate-180" : ""}`}
            />
