...
export async function GET(request: NextRequest) {
  try {
    ...
    // We need to find the integration ID from the state
    // First, let's get all integrations and check their OAuth states
    ...
    console.error("Error in Jira callback endpoint:", error);
    return NextResponse.redirect(
