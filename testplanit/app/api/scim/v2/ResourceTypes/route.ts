 ...
 * to, and any schema extensions IdPs can attach (D-03 — the enterprise User
 * extension is advertised on the User resource type with required: false).
 *
 * The two-element resources array is inlined in this handler per D-04 (no
 * helper, no DB read); Phase 7 owns the dynamic-enumeration refactor when
 * scimExtensions actually contains URN-prefixed keys.
 *
