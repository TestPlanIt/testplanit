...
test.describe("Nested Includes Regression Tests", () => {
  ...
  test("should return RepositoryCases with nested includes (steps, fieldValues, tags, template)", async ({
    ...
    await test.step("Create an isolated project, folder, and test case", async () => {
      // Create an isolated project for this test
      projectId = await api.createProject(`E2E NestedIncludes RC ${ts}`);
    ...
    await test.step("Add two steps to the case", async () => {
    ...
    await test.step("Create a tag and link it to the case", async () => {
    ...
    await test.step("Assert nested steps, tags, template, and fieldValues are returned", async () => {
  ...
  test("should return TestRuns with deeply nested includes (testRunCases, repositoryCase, results)", async ({
    ...
    await test.step("Create an isolated project, folder, and two test cases", async () => {
      // Create an isolated project for this test
      projectId = await api.createProject(`E2E NestedIncludes TR ${ts}`);
      folderId = await api.getRootFolderId(projectId);
    ...
    await test.step("Add two steps to the first test case", async () => {
    ...
    await test.step("Create a test run and add both cases to it", async () => {
    ...
    await test.step("Assert nested testCases, repositoryCase, and results are returned", async () => {
