...
test.describe("View Switching", () => {
  ...
  test("Default View is Folders @smoke", async ({ api, page }) => {
    ...
    await test.step("Verify the default view is Folders", async () => {
  ...
  test("Switch to Template View", async ({ api, page }) => {
    ...
    await test.step("Verify the Template view and its filter options are shown", async () => {
  ...
  test("Switch to State View", async ({ api, page }) => {
    ...
    await test.step("Switch to the State view", async () => {
      await switchToView(page, "State");
    });

    await test.step("Verify the State view and its filter options are shown", async () => {
  ...
  test("Switch to Creator View", async ({ api, page }) => {
    ...
    await test.step("Switch to the Creator view", async () => {
      await switchToView(page, "Creator");
    });

    await test.step("Verify the Creator view and its filter options are shown", async () => {
  ...
  test("Switch to Automation View", async ({ api, page }) => {
    ...
    await test.step("Switch to the Automation view", async () => {
      await switchToView(page, "Automation");
    });

    await test.step("Verify the Automation view and its filter options are shown", async () => {
  ...
  test("Switch to Tag View", async ({ api, page }) => {
    ...
    await test.step("Switch to the Tag view", async () => {
      await switchToView(page, "Tag");
    });

    await test.step("Verify the Tag view and its filter options are shown", async () => {
  ...
  test("Switch Back to Folders View", async ({ api, page }) => {
    ...
    await test.step("Verify the folder tree shows the Root Folder again", async () => {
  ...
  test("URL Updates When View Changes", async ({ api, page }) => {
    ...
    await test.step("Switch to Template view and verify the URL updates", async () => {
    ...
    await test.step("Switch to State view and verify the URL updates", async () => {
  ...
  test("View Persists After Page Reload", async ({ api, page }) => {
    ...
    await test.step("Switch to Template view and confirm it is persisted in the URL", async () => {
      // Switch to Template view
      await switchToView(page, "Template");
      viewSwitcher = await getViewSwitcher(page);
      await expect(viewSwitcher).toContainText(/Template/i);
    ...
    await test.step("Reload the page and verify the Template view persists", async () => {
      // Reload the page
      await page.reload();
  ...
  test("Folder View Shows Test Case Counts", async ({ api, page }) => {
    ...
    await test.step("Open the repository in the default Folders view", async () => {
      await repositoryPage.goto(projectId);
    ...
    await test.step("Verify the folder displays its test case count", async () => {
  ...
  test("Template View Shows Individual Template with Count", async ({
    ...
    await test.step("Create a folder with a test case using the default template", async () => {
    ...
    await test.step("Verify an individual template button is shown with a count", async () => {
  ...
  test("State View Shows Individual States with Icons", async ({
    ...
    await test.step("Create a test case so the State view has data", async () => {
    ...
    await test.step("Verify individual state buttons are shown", async () => {
  ...
  test("Creator View Shows Individual Creators", async ({ api, page }) => {
    ...
    await test.step("Create a test case so the current user appears as a creator", async () => {
    ...
    await test.step("Verify individual creator buttons are shown", async () => {
  ...
  test("Automation View Shows Automated and Not Automated Options", async ({
    ...
    await test.step("Create a test case so the Automation view has data", async () => {
    ...
    await test.step("Verify the All Cases, Automated and Not Automated options are shown", async () => {
  ...
  test("Direct URL Navigation to View", async ({ api, page }) => {
    ...
    await test.step("Navigate directly to the States view via URL", async () => {
  ...
  test("View Dropdown Shows All Available Options", async ({ api, page }) => {
    ...
    await test.step("Open the view switcher dropdown", async () => {
      // Open the view switcher dropdown
      const viewSwitcher = await getViewSwitcher(page);
      await viewSwitcher.click();
    });

    await test.step("Verify all standard view options are listed", async () => {
      ...
      await expect(
        options.filter({ hasText: /Creator/i }).first()
      ).toBeVisible();
  ...
  test("Keyboard Navigation in View Switcher", async ({ api, page }) => {
    ...
    await test.step("Open the view switcher with the keyboard", async () => {
    ...
    await test.step("Navigate with arrow keys and close with Escape", async () => {
  ...
  test("Test Case Table Shows Required Columns", async ({ api, page }) => {
    ...
    await test.step("Verify the Name and State columns are shown in the table", async () => {
  ...
  test("Empty Folder Shows No Test Cases Message", async ({ api, page }) => {
    ...
    await test.step("Create an empty folder", async () => {
      // Create an empty folder
      const folderName = `Empty Folder ${Date.now()}`;
      folderId = await api.createFolder(projectId, folderName);
    });

    await test.step("Open the repository and select the empty folder", async () => {
      await repositoryPage.goto(projectId);
