...
test.describe("Tags", () => {
  ...
  test("Create Tag", async ({ page }) => {
    ...
    await test.step("Open the admin tags page", async () => {
    ...
    await test.step("Enter the tag name and submit", async () => {
      const dialog = page.locator('[role="dialog"]');
    ...
    await test.step("Filter and verify the tag was created", async () => {
  ...
  test("Apply Existing Tag to Test Case", async ({ api, page }) => {
    ...
    await test.step("Seed folder and test case", async () => {
    ...
    await test.step("Open the test case in edit mode", async () => {
    ...
    await test.step("Select the tag in the tags field", async () => {
    ...
    await test.step("Save the tag assignment", async () => {
    ...
    await test.step("Verify the tag is displayed in view mode", async () => {
  ...
  test("Apply Multiple Tags to Test Case", async ({ api, page }) => {
    ...
    await test.step("Add both tags in the tags field", async () => {
      // Find the tags section - ManageTags uses react-select
      const tagSelectInput = page.locator(".min-w-\\[200px\\] input").first();
      await expect(tagSelectInput).toBeVisible({ timeout: 10000 });
    ...
    await test.step("Save the tag assignments", async () => {
    ...
    await test.step("Verify both tags are displayed in view mode", async () => {
  ...
  test("Remove Tag from Test Case", async ({ api, page }) => {
    ...
    await test.step("Seed test case with the tag attached", async () => {
      // Create a folder and test case
    ...
    await test.step("Open the test case and confirm the tag is shown", async () => {
    ...
    await test.step("Enter edit mode and remove the tag", async () => {
      // Click Edit to enter edit mode
      const editButton = page.locator('button:has-text("Edit")').first();
      await expect(editButton).toBeVisible({ timeout: 10000 });
      await editButton.click();
    ...
    await test.step("Save the removal and wait for the API response", async () => {
    ...
    await test.step("Verify the tag is no longer displayed", async () => {
  ...
  test("Edit Tag Name", async ({ api, page }) => {
    ...
    let filterInput: import("@playwright/test").Locator | undefined;
    ...
    await test.step("Filter to find the tag and open its edit dialog", async () => {
      ...
      filterInput = page.locator('input[placeholder*="Filter"]').first();
    ...
    await test.step("Change the tag name and submit", async () => {
      const dialog = page.locator('[role="dialog"]');
    ...
    await test.step("Filter and verify the new name appears", async () => {
  ...
  test("Delete Tag", async ({ api, page }) => {
    ...
    await test.step("Confirm deletion in the alert dialog", async () => {
  ...
  test("Tags Display in Test Case List", async ({ api, page }) => {
    ...
    await test.step("Seed test case and assign a tag", async () => {
      // Create a folder and test case
    ...
    await test.step("Open the folder and confirm the test case is listed", async () => {
    ...
    await test.step("Open the tags popover and verify the tag name", async () => {
      const testCaseRow = page
        .locator(`[data-row-id="${testCaseId!}"]`)
        .first();
  ...
  test("Bulk Remove Tags from Test Cases", async ({ api, page }) => {
    ...
    await test.step("Seed two test cases tagged via API", async () => {
    ...
    await test.step("Open the folder and select both test cases", async () => {
      await repositoryPage.goto(projectId);
      await repositoryPage.selectFolder(folderId!);
      await page.waitForLoadState("networkidle");
    ...
    await test.step("Remove the tag chip and save", async () => {
      const bulkEditModal = page.locator('[role="dialog"]');
    ...
    await test.step("Verify the tag was removed from the first test case", async () => {
  ...
  test("Bulk Edit - Assign Tags", async ({ api, page }) => {
    ...
    await test.step("Seed two test cases", async () => {
      // Create a folder and two test cases
    ...
    await test.step("Assign the tag and save", async () => {
      const bulkEditModal = page.locator('[role="dialog"]');
    ...
    await test.step("Verify the tag is assigned on the first test case", async () => {
    ...
    await test.step("Verify the tag is assigned on the second test case", async () => {
  ...
  test("Tag Autocomplete Suggestions", async ({ api, page }) => {
    ...
    await test.step("Type the prefix and verify autocomplete suggestions", async () => {
    ...
    await test.step("Verify the selected tag appears as a chip", async () => {
  ...
  test("Tags Are Visible Across Projects", async ({ api, page }) => {
    ...
    await test.step("Seed a test case in project 2", async () => {
    ...
    await test.step("Open the project 2 test case in edit mode", async () => {
      // Navigate to the test case detail page in PROJECT 2
      await page.goto(
        `/en-US/projects/repository/${project2Id}/${testCaseId!}`
      );
      await page.waitForLoadState("networkidle");
    ...
    await test.step("Find and select the globally created tag", async () => {
      // Find the tag select input
      const tagSelectInput = page.locator(".min-w-\\[200px\\] input").first();
      await expect(tagSelectInput).toBeVisible({ timeout: 10000 });
    ...
    await test.step("Save and verify the global tag is displayed", async () => {
      // Save the test case
      const saveButton = page
        .locator('button[type="submit"]:has(svg.lucide-save)')
        .first();
  ...
  test("Tag Case Insensitivity", async ({ page }) => {
    ...
    let addTagButton: import("@playwright/test").Locator | undefined;
    let filterInput: import("@playwright/test").Locator | undefined;
    ...
    await test.step("Verify the lowercase tag appears", async () => {
    ...
    await test.step("Attempt the uppercase tag and verify it is rejected", async () => {
      const dialog = page.locator('[role="dialog"]');
      ...
      const errorMessage = dialog.locator(
        "text=/already exists|Name is taken/i"
      );
    ...
    await test.step("Verify only the lowercase tag exists", async () => {
  ...
  test("Restore Soft-Deleted Tag on Create", async ({ api, page }) => {
    ...
    await test.step("Open the admin tags page and confirm the tag is hidden", async () => {
      // Navigate to admin tags page
      await page.goto("/en-US/admin/tags");
      await page.waitForLoadState("networkidle");
    ...
    await test.step("Create a tag with the same name", async () => {
    ...
    await test.step("Verify the tag is restored and visible", async () => {
  ...
  test("Edit Tag to Soft-Deleted Tag Name", async ({ api, page }) => {
    ...
    let filterInput: import("@playwright/test").Locator | undefined;
    let tableBody: import("@playwright/test").Locator | undefined;

    await test.step("Open the admin tags page and edit the active tag", async () => {
      // Navigate to admin tags page
      await page.goto("/en-US/admin/tags");
      await page.waitForLoadState("networkidle");
    ...
    await test.step("Rename the active tag to the deleted tag's name", async () => {
    ...
    await test.step("Verify the tag now uses the new name", async () => {
    ...
    await test.step("Verify the old name no longer exists as an active tag", async () => {
      ...
      await expect(
        tableBody!.locator(`text="${activeTagName}"`)
      ).not.toBeVisible({
        timeout: 5000,
      });
    });
  ...
  test("Tag with Special Characters", async ({ page }) => {
    ...
    await test.step("Open the add tag dialog on the admin tags page", async () => {
      // Navigate to admin tags page
      await page.goto("/en-US/admin/tags");
      await page.waitForLoadState("networkidle");
    ...
    await test.step("Create a tag with special characters", async () => {
      const dialog = page.locator('[role="dialog"]');
    ...
    await test.step("Verify the special-character tag appears", async () => {
  ...
  test("Tag Usage Count", async ({ api, page }) => {
    ...
    await test.step("Open the admin tags page and filter to the tag", async () => {
      // Navigate to admin tags page
      await page.goto("/en-US/admin/tags");
      await page.waitForLoadState("networkidle");
