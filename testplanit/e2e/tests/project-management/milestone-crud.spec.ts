...
test.describe("Milestone CRUD", () => {
  test("should create a milestone via the Add Milestone modal", async ({
    ...
    await test.step("Open the Add Milestone modal", async () => {
    ...
    await test.step("Fill in the milestone name and type", async () => {
    ...
    await test.step("Save and confirm the milestone was created", async () => {
  ...
  test("should edit a milestone via the detail page", async ({ page, api }) => {
    ...
    let saveButton: ReturnType<typeof page.getByRole> | undefined;

    await test.step("Open the milestone detail page in edit mode", async () => {
    ...
    await test.step("Rename the milestone and save", async () => {
    ...
    await test.step("Confirm the updated name is shown", async () => {
  ...
  test("should show child milestone on parent detail page when nested via API", async ({
    ...
    await test.step("Confirm the child milestone is listed", async () => {
  ...
  test("should complete a started milestone", async ({ page, api }) => {
    ...
    await test.step("Open the milestone menu and choose Complete", async () => {
      ...
      // Click Complete
      const completeMenuItem = page.getByRole("menuitem", {
        name: /Complete/i,
      });
    ...
    await test.step("Complete the milestone in the dialog", async () => {
    ...
    await test.step("Reload and verify the milestone moved to Completed", async () => {
  ...
  test("should delete a milestone (with cascade to children)", async ({
    ...
    await test.step("Open the milestone menu and choose Delete", async () => {
      // Find the 3-dot dropdown trigger near this milestone
  ...
  test("should delete a milestone from the detail page", async ({
    ...
    await test.step("Delete the milestone and confirm", async () => {
    ...
    await test.step("Verify redirect back to the milestones list", async () => {
