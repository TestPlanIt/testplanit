...
export { registerAll, registerWhoami, registerCases, registerFolders } from "./tools/index.js";
...
export type { ToolRegistryDeps, WhoamiDeps, CasesDeps, FoldersDeps } from "./tools/index.js";
