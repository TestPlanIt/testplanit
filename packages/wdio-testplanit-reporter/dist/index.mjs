...
var TestPlanItReporter = class _TestPlanItReporter extends WDIOReporter {
  client;
  reporterOptions;
  state;
  currentSuite = [];
...
export { RUN_ID_ENV_VAR, TestPlanItReporter, TestPlanItService, TestPlanItReporter as default };
